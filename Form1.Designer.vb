...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Button1 = New Button()
        Label12 = New Label()
        btnOpenAddOrRemovePrograms = New Button()
        Label5 = New Label()
        Label4 = New Label()
        Label3 = New Label()
        Label2 = New Label()
        ...
        GroupBox1.Controls.Add(btnOpenAddOrRemovePrograms)
        GroupBox1.Controls.Add(Label5)
        GroupBox1.Controls.Add(Label4)
        GroupBox1.Controls.Add(Label3)
        GroupBox1.Controls.Add(Label2)
        GroupBox1.Controls.Add(Label1)
        GroupBox1.Controls.Add(btnDiskDefragmenter)
        GroupBox1.Controls.Add(btnTaskManager)
        ...
        Label3.Location = New Point(79, 56)
        Label3.Name = "Label3"
        ...
        btnDiskDefragmenter.Size = New Size(65, 22)
        ...
        btnTaskManager.Location = New Point(208, 51)
        btnTaskManager.Name = "btnTaskManager"
        btnTaskManager.Size = New Size(65, 22)
        ...
        btnWindowsUpdate.Size = New Size(65, 22)
        ...
        btnSystemRestore.Size = New Size(65, 22)
        ...
        btnWindowsSecurity.Location = New Point(208, 22)
        btnWindowsSecurity.Name = "btnWindowsSecurity"
        btnWindowsSecurity.Size = New Size(65, 22)
        ...
        ' treeViewXML
        ' 
        treeViewXML.Location = New Point(6, 34)
        treeViewXML.Name = "treeViewXML"
        treeViewXML.Size = New Size(477, 314)
        ...
        MASActivationToolStripMenuItem.Size = New Size(193, 22)
        ...
        WinUtilToolStripMenuItem.Size = New Size(193, 22)
        ...
        RecoverWindowsLicToolStripMenuItem.Size = New Size(193, 22)
        RecoverWindowsLicToolStripMenuItem.Text = "Legacy Apps Launcher"
        ' 
        ' WinActivationScanToolStripMenuItem
        ' 
        WinActivationScanToolStripMenuItem.Name = "WinActivationScanToolStripMenuItem"
        WinActivationScanToolStripMenuItem.Size = New Size(193, 22)
        ...
        HelpToolStripMenuItem1.Size = New Size(193, 22)
        ...
        LstPingResults.Location = New Point(6, 154)
        ...
        ' IpBox
        ' 
        IpBox.Location = New Point(336, 154)
        IpBox.Name = "IpBox"
    ...
    Friend WithEvents nfoScan As Button
    Friend WithEvents treeViewXML As TreeView
    Friend WithEvents MenuStrip1 As MenuStrip
    Friend WithEvents FileToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ExportScanToolStripMenuItem As ToolStripMenuItem
    ...
    Friend WithEvents LstPingResults As ListBox
    Friend WithEvents btnOpenAddOrRemovePrograms As Button
    Friend WithEvents Label12 As Label
    Friend WithEvents BtnPing As Button
    Friend WithEvents Button1 As Button
    Friend WithEvents Label7 As Label
    Friend WithEvents ToolBox As TabControl
    Friend WithEvents TabPage1 As TabPage
    Friend WithEvents Scan As TabPage
